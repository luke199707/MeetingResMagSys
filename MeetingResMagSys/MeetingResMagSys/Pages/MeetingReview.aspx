<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingReview.aspx.cs" Inherits="MeetingResMagSys.Pages.MeetingReview" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="breadcrumbs" id="breadcrumbs" style="background-color: #ffffff">
                    <ul class="breadcrumb">
                        <li><i class="fa fa-home fa-fw home-icon"></i><a href="#">会议室预订审核</a></li>
                        <li class="active">会议室预订审核</li>
                    </ul>
                </div>
                <!-- Content -->
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="btnPass" runat="server" CommandArgument='<%# Bind("meetingId") %>' OnClick="btnPass_Click" CssClass="btn btn-success" Text="通过" />
                                        <asp:Button ID="btnRefuse" runat="server" CommandArgument='<%# Bind("meetingId") %>' OnClick="btnRefuse_Click" CssClass="btn btn-danger" Text="拒绝" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                ...
                <div class="modal fade" id="ReasonModal" tabindex="-1" role="dialog" aria-labelledby="ReasonModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="ReasonModalLabel">拒绝理由</h4>
                            </div>
                            <div class="modal-body">
                                <asp:TextBox ID="txtRefRea" class="form-control" runat="server" placeholder="至少为0个字" TextMode="MultiLine" Rows="8"></asp:TextBox>
                            </div>
                            <div class="modal-footer" style="background-color: white">
                                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                <asp:Button ID="btnRefuseCertain" runat="server" Text="拒绝申请" OnClick="btnRefuseCertain_Click" CssClass="btn btn-danger" />
                            </div>
                        </div>
                    </div>
                </div>
