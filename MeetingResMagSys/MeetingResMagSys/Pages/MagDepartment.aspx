<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MagDepartment.aspx.cs" Inherits="MeetingResMagSys.Pages.MagDepartment" %>
...
<body>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="breadcrumbs" id="breadcrumbs" style="background-color: #ffffff">
                    <ul class="breadcrumb">
                        <li><i class="fa fa-home fa-fw home-icon"></i><a href="#">组织架构</a></li>
                        <li class="active">部门管理</li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 15px">
                        <li>
                            <asp:Button data-toggle="modal" data-target="#AddModal" ID="btnAdd" runat="server" Text="添加部门" CssClass="btn btn-primary" />
                        </li>
                    </ul>
                </div>
                <!-- Content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchName" runat="server" class="form-control" placeholder="部门名称"></asp:TextBox>
                    ...
                    <div class="row no-margin">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="部门ID" SortExpression="departmentId">
                                    <ItemTemplate>
                                        <%#Eval("departmentId")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="部门名称" SortExpression="name">
                                    <ItemTemplate>
                                        <%#Eval("name")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="部门简介" SortExpression="introduction">
                                    <ItemTemplate>
                                        <%#Eval("introduction")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--<asp:TemplateField HeaderText="上级部门" SortExpression="superiorDepartment">
                                    <ItemTemplate>
                                        <%#GetSuperiorDepartmentName(Eval("superiorDepartment").ToString())%>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                                <asp:TemplateField HeaderText="部门主管" SortExpression="supervisor">
                                    <ItemTemplate>
                                        <%#GetSupervisorName(Eval("supervisor").ToString())%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%#Bind("departmentId") %>' OnClick="lbtnEdit_Click"><i class="fa fa-edit fa-2x"></i></asp:LinkButton>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:void(0)" onclick="del('<%#Eval("departmentId")%>')"><i class="fa fa-trash-o fa-2x"></i></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label><span style="color: red">*</span>部门主管</label>
                                    <asp:DropDownList ID="ddlSupervisor" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <%--<div class="form-group">
                                    <label>上级部门</label>
                                    <asp:DropDownList ID="ddlSuperiorDepartment" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>--%>
                                <div class="form-group">
                                    <label>部门简介</label>
                ...
                <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="EditModalLabel">部门信息</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label><span style="color: red">*</span>部门名称</label>
                                ...
                                <div class="form-group">
                                    <label><span style="color: red">*</span>部门主管</label>
                                    <asp:DropDownList ID="eddlSupervisor" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <%--<div class="form-group">
                                    <label>上级部门</label>
                                    <asp:DropDownList ID="eddlSuperiorDepartment" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>--%>
                                <div class="form-group">
                                    <label>部门简介</label>
    ...
    <script type="text/javascript">
        ...
        function del(departmentId) {
            if (confirm('确认要删除此项？')) {
                $.post("../Handler/DepartmentDel.ashx", { "departmentId": departmentId }, function (data) {
                    if (data == "ok") {
                        location.href = "MagDepartment.aspx";
                    }
                    if (data == "AllUser_notNull") {
                        toastr.info("还有成员属于该部门，该部门暂时不可删除！");
                    }
                    if (data == "MeetingRoom_notNull") {
                        toastr.info("还有会议室被该部门负责，该部门暂时不可删除！");
                    }
                });
            } else {
                return false;
