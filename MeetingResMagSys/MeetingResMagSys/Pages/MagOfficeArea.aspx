<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MagOfficeArea.aspx.cs" Inherits="MeetingResMagSys.Pages.MagOfficeArea" %>
...
<body>
            ...
            <ContentTemplate>
                ...
                <div class="breadcrumbs" id="breadcrumbs" style="background-color: #ffffff">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">办公区域管理</li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 15px">
                        <li>
                            <asp:Button data-toggle="modal" data-target="#AddModal" ID="btnAdd" runat="server" Text="添加办公区域" CssClass="btn btn-primary" />
                        </li>
                    </ul>
                </div>
                <!-- Content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchName" runat="server" class="form-control" placeholder="区域名"></asp:TextBox>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="序号" SortExpression="id">
                                    <ItemTemplate>
                                        ...
                                        <asp:Literal ID="LiteralCode" runat="server" Text='<%#Eval("officeAreaId") %>' Visible="false"></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="办公区域ID" SortExpression="officeAreaId">
                                    <ItemTemplate>
                                        <%#Eval("officeAreaId")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="区域名" SortExpression="name">
                                    <ItemTemplate>
                                        <%#Eval("name")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="区域电话" SortExpression="phone">
                                    <ItemTemplate>
                                        <%#Eval("phone")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="服务主管" SortExpression="serviceDirector">
                                    <ItemTemplate>
                                        <%# GetServiceDirectorName(Eval("serviceDirector").ToString())%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%#Bind("id") %>' OnClick="lbtnEdit_Click"><i class="fa fa-edit fa-2x"></i></asp:LinkButton>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0)" onclick="del('<%#Eval("officeAreaId")%>')"><i class="fa fa-trash-o fa-2x"></i></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">办公区域信息</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label><span style="color: red">*</span>区域名称</label>
                                    <asp:TextBox ID="txtName" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>区域地址</label>
                                    <asp:TextBox ID="txtAddress" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>区域电话</label>
                                    <asp:TextBox ID="txtPhone" class="form-control" runat="server" placeholder="" TextMode="Phone"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label><span style="color: red">*</span>服务主管</label>
                                    <asp:DropDownList ID="ddlserviceDirector" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>简介</label>
                ...
                <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="EditModalLabel">办公区域信息</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label><span style="color: red">*</span>区域名称</label>
                                ...
                                <div class="form-group">
                                    <label>区域地址</label>
                                    <asp:TextBox ID="etxtAddress" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>区域电话</label>
                                    <asp:TextBox ID="etxtPhone" class="form-control" runat="server" placeholder="" TextMode="Phone"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label><span style="color: red">*</span>服务主管</label>
                                    <asp:DropDownList ID="eddlserviceDirector" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>简介</label>
    ...
    <script type="text/javascript">
        ...
        function del(officeAreaId) {
            if (confirm('确认要删除此项？')) {
                $.post("../Handler/OfficeAreaDel.ashx", { "officeAreaId": officeAreaId }, function (data) {
                    if (data == "ok") {
                        location.href = "MagOfficeArea.aspx";
                    }
                    if (data == "MeetingRoom_notnull") {
                        toastr.info("该办公区域内还有会议室，暂时不可删除！");
                    }
                });
            } else {
                return false;
