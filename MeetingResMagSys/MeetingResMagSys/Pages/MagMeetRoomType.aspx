<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MagMeetRoomType.aspx.cs" Inherits="MeetingResMagSys.Pages.MagMeetRoomType" %>
...
<body>
            ...
            <ContentTemplate>
                ...
                <div class="breadcrumbs" id="breadcrumbs" style="background-color: #ffffff">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">会议室类型管理</li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 15px">
                        <li>
                            <asp:Button data-toggle="modal" data-target="#AddModal" ID="btnAdd" runat="server" Text="添加会议室类型" CssClass="btn btn-primary" />
                        </li>
                    </ul>
                </div>
                <!-- Content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchName" runat="server" class="form-control" placeholder="类型名称"></asp:TextBox>
                    ...
                    <div class="row no-margin">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="类型ID" SortExpression="name">
                                    <ItemTemplate>
                                        <%#Eval("RoomTypeId")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="简介" SortExpression="introduction">
                                    <ItemTemplate>
                                        <%#Eval("introduction")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%#Bind("RoomTypeId") %>' OnClick="lbtnEdit_Click"><i class="fa fa-edit fa-2x"></i></asp:LinkButton>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="javascript:void(0)" onclick="del('<%#Eval("RoomTypeId")%>')"><i class="fa fa-trash-o fa-2x"></i></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">会议室类型信息</h4>
                            </div>
                ...
                <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="EditModalLabel">会议室类型信息</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label><span style="color: red">*</span>类型名称</label>
    ...
    <script type="text/javascript">
        ...
        function del(RoomTypeId) {
            if (confirm('确认要删除此项？')) {
                $.post("../Handler/MeetRoomTypeDel.ashx", { "RoomTypeId": RoomTypeId }, function (data) {
                    if (data == "ok") {
                        location.href = "MagMeetRoomType.aspx";
                    }
                    if (data == "MeetingRoom_notnull") {
                        toastr.info("还有会议室属于该类型，暂时不可删除！");
                    }
                });
            } else {
                return false;
