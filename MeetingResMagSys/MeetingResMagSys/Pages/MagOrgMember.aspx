<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MagOrgMember.aspx.cs" Inherits="MeetingResMagSys.Pages.MagOrgMember" %>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchUserId" runat="server" class="form-control" placeholder="成员ID"></asp:TextBox>
                        ...
                        <div class="col-xs-2">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchName" runat="server" class="form-control" placeholder="成员名称"></asp:TextBox>
                        ...
                        <div class="col-xs-2">
                            <div class="input-group">
                                <asp:TextBox ID="txtSearchPhone" runat="server" class="form-control" placeholder="成员电话"></asp:TextBox>
                    ...
                    <div class="row no-margin">
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="成员ID" SortExpression="userId">
                                    <ItemTemplate>
                                        <%#Eval("userId")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="成员名称" SortExpression="name">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="所属部门" SortExpression="departmentName">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="账户状态" SortExpression="available">
                                    <ItemTemplate>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label><span style="color: red">*</span>成员名称</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtEmail" class="form-control" runat="server" placeholder="" TextMode="Email"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>电话</label>
    ...
    <script type="text/javascript">
        ...
        function del(userId) {
            if (confirm('确认要删除此项？')) {
                $.post("../Handler/OrgMemberDel.ashx", { "userId": userId }, function (data) {
                    if (data == "ok") {
                        location.href = "MagOrgMember.aspx";
                    }
                });
            } else {
                return false;
